...
class PrivateRecipeApiTest(TestCase):
    ...
    def test_recipe_list_limited_to_user(self):
        """Test list of recipes ios limited to authenticated user."""
    ...
    def test_update_useer_returns_error(self):
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Thai vagetable curry')
